	...
	function widget( $args, $instance ) {
		...
		if($title):
			...
			if ( $search_submit )
				...
				$search .= '<input style="width:95%;" class="field" type="text" class="dt-submit" name="s" id="s-' . $search_num . '" value="' . $search_text . '" onfocus="if(this.value==this.defaultValue)this.value=\'\';" onblur="if(this.value==\'\')this.value=this.defaultValue;" />';
