...
$engine_version = '1.2'; // engine/engine-changelog.txt
define('DT_ENGINE_VERSION', $engine_version); // Engine framework version, as set above
...
function dt_script_enqueues() {
	...
	if(isset($_GET['page']) && ($_GET['page']=='dt-options')) {
    	...
    	wp_enqueue_script( 'farbtastic', 'jquery' );
