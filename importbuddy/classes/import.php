...
# END WordPress\n";
	...
	function connect_database() {
		...
		if ( false === ( $connect_identifier = @mysql_connect( pb_backupbuddy::$options['db_server'], pb_backupbuddy::$options['db_user'], pb_backupbuddy::$options['db_password'] ) ) ) {
