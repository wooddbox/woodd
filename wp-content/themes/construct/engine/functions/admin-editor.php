...
function dt_tiny_mce_before_init($settings) {
	$style_formats = array(
		...
		array( 'title' => 'White Box', 'inline' => 'div', 'classes' => 'alert white' ),
		array( 'title' => 'Yellow Box', 'inline' => 'div', 'classes' => 'alert yellow' ),
		array( 'title' => 'Green Box', 'inline' => 'div', 'classes' => 'alert green' ),
		array( 'title' => 'Red Box', 'inline' => 'div', 'classes' => 'alert red' ),
