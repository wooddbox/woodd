...
<script type='text/javascript' src='<?php echo $dt_dir; ?>/engine/js/admin.js'></script>
<script type='text/javascript' src='<?php echo $dt_dir; ?>/engine/js/ajaxupload.js'></script>
<script type='text/javascript' src='<?php echo $dt_dir; ?>/engine/js/dt-admin.js'></script>
