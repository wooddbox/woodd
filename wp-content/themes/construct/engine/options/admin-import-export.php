			...
			<form class="dt_options_form" id="dt_import_default_content">
				...
				<div class="option option-textarea cf">
					...
					<div class="option-wrap">
						...
						<div class="option-description">
							<?php _e('Use the import tool to upload the <code>sample_site_content.xml</code> file included in the main folder of your theme. This will load demo site data including posts, pages, comments, categories, images, etc', 'engine'); ?>.
						</div>
					</div><!-- .option-wrap -->
				</div><!-- .option -->
			</form>
