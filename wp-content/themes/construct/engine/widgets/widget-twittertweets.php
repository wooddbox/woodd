...
/* ==  Widget Setup ==============================*/	
	...
	function DT_Twitter() {
		...
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'dt_tweet_widget' );
	...
	function widget( $args, $instance ) {
		...
		/* Display Latest Tweets */
		 ?>
            ...
            <a href="http://twitter.com/<?php echo $dt_twitter_username; ?>" class="follow-me"><?php echo $tweettext; ?></a>
